...
import { Text, Heading, Link, Image } from '@MilkshakeSwap-libs/uikit'
...
const HowItWorks = () => {
  ...
  return (
    <LayoutWrapper>
      ...
      <StyledLink href="https://docs.MilkshakeSwap.finance/lottery-1">{TranslateString(610, 'Read more')}</StyledLink>
    </LayoutWrapper>
  )
}
